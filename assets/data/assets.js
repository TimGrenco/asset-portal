...
/* =============================================================================
   PRODUCT TRAINING — lives on G Pen Training (training.gpen.com), not here.
   Each product page links to its course there; certification, quizzes and
   rewards all happen on that site. Keys are product names, values are the
   course slugs in the training site's #/course/<slug> routes. The Retro editions
   are the same device as their base model, so they share its course. A product
   with no entry simply shows no training link.
   ========================================================================== */
window.PORTAL_TRAINING_SITE = "https://training.gpen.com/";
window.PORTAL_TRAINING_COURSES = {
  "Dash II":              "dash-ii",
  "Dash+":                "dash-plus",
  "Slim 3-Piece Grinder": "grinder",
  "Micro II":             "micro-ii",
  "Melt Hot Knife":       "melt-hot-knife",
  "Hydout":               "hydout",
  "Hydout — Retro":       "hydout",
