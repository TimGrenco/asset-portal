...
window.PORTAL_I18N.fr = {
  "ui": {
    ...
    "Dry-herb devices & accessories": "Appareils et accessoires pour herbes sèches",
    "Grinder": "Grinder",
    "This folder has {n} files. Downloading them one at a time can take several minutes and your browser may block it. Open the full Dropbox download instead?": "Ce dossier contient {n} fichiers. Les télécharger un par un peut prendre plusieurs minutes et votre navigateur risque de le bloquer. Ouvrir plutôt le téléchargement Dropbox complet ?",
    "{n} downloads starting — allow multiple if your browser asks, or use “Download all”.": "{n} téléchargements démarrent — autorisez-en plusieurs si votre navigateur le demande, ou utilisez « Tout télécharger ».",
    "Add your store name, mailing address and email so we can ship your order": "Indiquez le nom de votre magasin, l’adresse postale et l’e-mail afin que nous puissions expédier votre commande",
    "Enter a valid email address": "Saisissez une adresse e-mail valide",
    "Add your name and email so we can reply": "Indiquez votre nom et votre e-mail afin que nous puissions vous répondre",
    "Click a video to watch it, and download it or open it on YouTube where available.": "Cliquez sur une vidéo pour la regarder, puis téléchargez-la ou ouvrez-la sur YouTube lorsque c’est disponible.",
    "document": "document",
    "documents": "documents",
    "item": "élément",
    "items": "éléments",
    "These assets are provided for approved partner, press, and retail use. Please don't alter logos or product imagery. Need something specific or a different format? Use “Request an asset.”": "Ces ressources sont fournies pour un usage autorisé par les partenaires, la presse et les points de vente. Merci de ne pas modifier les logos ni les visuels produit. Besoin d’un élément précis ou d’un autre format ? Utilisez « Demander une ressource ».",
    "Brand Documents": "Documents de marque",
    "Dry Herb Vaporizer": "Vaporisateur à herbes sèches",
    "510 Cartridge Battery": "Batterie pour cartouches 510",
    "Electric Hot Knife": "Couteau chauffant électrique",
    "Concentrate Vaporizer": "Vaporisateur à concentrés",
  ...
  "training": {
      "Micro II": {
        "tagline": "Découvrez le G Pen Micro II, puis réussissez le quiz pour devenir Spécialiste Produit certifié.",
        "minutes": 7,
        "passPct": 80,
        "modules": [
          {
          ...
          {
            "title": "Chauffe et flux d'air",
            "points": [
              "Trois niveaux de chauffe : <strong>LOW ~295°F</strong>, <strong>MEDIUM ~340°F</strong>, <strong>HIGH ~395°F</strong>.",
              "Les températures varient d'environ <strong>±15–30°F</strong> selon la durée d'activation de la résistance : expliquez-le au client.",
              "<strong>Montée en température en 5 secondes</strong>, et l'appareil vibre une fois la température atteinte.",
              "Le <strong>flux d'air réglable</strong> se trouve à l'opposé de l'écran : vers la gauche pour plus d'air, vers la droite pour une bouffée plus restreinte."
            ]
          },
          {
            "title": "Commandes et modes de chauffe",
            "points": [
              "<strong>Cinq clics</strong> allument ou éteignent le Micro II.",
              "<strong>Trois clics</strong> changent la température : un nuage LOW, deux nuages MEDIUM, trois nuages HIGH.",
              "<strong>Mode Session</strong> : deux clics lancent un cycle automatique de <strong>20 secondes au total, montée en température d'environ 5 secondes comprise</strong>. Deux clics de plus l'annulent.",
              "<strong>Chauffe Manuelle</strong> : maintenez le bouton jusqu'à <strong>25 secondes au total, montée en température comprise</strong>.",
              "<strong>Arrêt automatique au bout de 10 minutes</strong> pour préserver la batterie."
            ]
          },
          {
            ...
            "points": [
              ...
              "À la première utilisation, le concentré doit <strong>imprégner la plaque céramique poreuse</strong> ; les premières bouffées peuvent donc être légères, surtout en LOW."
            ]
          }
        ],
        "quiz": [
          {
            "q": "Quel type de produit est le G Pen Micro II ?",
            "choices": [
              "Un vaporisateur à herbes sèches",
              "Un vaporisateur à concentrés",
              "Une batterie 510",
              "Un grinder"
            ],
            "why": "Le Micro II est un vaporisateur à concentrés ; il n'est pas conçu pour les fleurs."
          },
          {
            "q": "Quel est le prix conseillé du Micro II ?",
            "choices": [
              "$29.95",
              "$39.95",
              "$49.95",
            ...
            "why": "Le Micro II est vendu $49.95."
          },
          {
            "q": "Quels sont les trois niveaux de température ?",
            "choices": [
              "~250°F / ~300°F / ~350°F",
              "~295°F / ~340°F / ~395°F",
              "~315°F / ~365°F / ~415°F",
            ...
            "why": "LOW se situe vers 295°F, MEDIUM vers 340°F et HIGH vers 395°F."
          },
          {
            "q": "Comment passe-t-on d'un niveau de température à l'autre ?",
            "choices": [
              "Un clic",
              "Deux clics",
              "Trois clics",
            ...
            "why": "Trois clics font défiler LOW, MEDIUM et HIGH, indiqués par un, deux ou trois nuages."
          },
          {
            "q": "Comment allume-t-on ou éteint-on le Micro II ?",
            "choices": [
              "Deux clics",
              "Trois clics",
              "Cinq clics",
            ...
            "why": "Cinq clics allument ou éteignent l'appareil."
          },
          {
            "q": "Qu'est-ce que le Mode Session ?",
            "choices": [
              "Un cycle de chauffe automatique de 20 secondes, montée en température comprise",
              "Un mode qui double l'autonomie de la batterie",
              "Un réglage qui verrouille la température",
              "Un cycle de nettoyage"
            ],
            "why": "Deux clics lancent le Mode Session : un cycle de 20 secondes décompté dès le début de la chauffe, montée en température d'environ 5 secondes comprise."
          },
          {
            "q": "Combien de temps la Chauffe Manuelle peut-elle durer ?",
            "choices": [
              "Jusqu'à 10 secondes",
              "Jusqu'à 15 secondes",
              "Jusqu'à 25 secondes, montée en température comprise",
              "Indéfiniment, jusqu'au relâchement du bouton"
            ],
            "why": "La Chauffe Manuelle dure jusqu'à 25 secondes au total, montée en température comprise, puis s'arrête automatiquement."
          },
          {
            "q": "Combien de sessions offre une charge complète ?",
            "choices": [
              "Jusqu'à 60",
              "Jusqu'à 90",
              "Jusqu'à 120",
          ...
          },
          {
            ...
            "choices": [
              "Batterie, réservoir céramique, embout en silicone et un câble de charge USB-C",
              "Batterie, réservoir céramique et embout en silicone, sans câble de charge",
              "Batterie et l'accessoire Sidecar",
              "Batterie, réservoir céramique et l'adaptateur pour rig de 14 mm"
            ],
            "why": "Aucun câble de charge n'est fourni avec le Micro II : n'importe quel chargeur USB-C convient. Le Sidecar et l'adaptateur pour rig sont vendus séparément."
          },
          {
            "q": "Un client indique que sa toute première session a produit peu de vapeur. Quelle en est la cause probable ?",
            "choices": [
              "La batterie est défectueuse et doit être remplacée",
              "Le concentré doit d'abord imprégner la plaque céramique poreuse",
              "L'appareil a été livré sans atomiseur",
              "Il a besoin d'une mise à jour du firmware"
            ],
            "why": "À la première utilisation, le concentré doit imprégner la plaque céramique poreuse ; d'autres activations peuvent être nécessaires, surtout en LOW."
          }
        ]
      },
    "Slim 3-Piece Grinder": {
     "tagline": "Découvrez le G Pen Slim 3-Piece Grinder, puis réussissez le quiz pour devenir Spécialiste Produit certifié.",
     "minutes": 6,
     "passPct": 80,
     "modules": [
      {
      ...
      {
       "title": "Ce qui le distingue",
       "points": [
        "Des <strong>dents micro-arrondies</strong> — et non les dents acérées d'un grinder classique — séparent la fleur en douceur.",
        "Cette action plus douce aide à <strong>préserver les cannabinoïdes et les terpènes</strong>, porteurs de la puissance et des arômes de chaque variété.",
        "La géométrie arrondie des dents et un <strong>intérieur lisse</strong> réduisent les frottements et limitent les résidus : moins de fleur reste piégée.",
        "Il est <strong>sans tamis</strong> : une conception en 3 parties ne comporte aucun tamis à kief, si bien que les <strong>trichomes restent mélangés à la matière moulue</strong> au lieu d'être filtrés à part."
       ]
      },
      {
       "title": "Fabrication et tests indépendants",
       "points": [
        "Usiné dans un <strong>aluminium anodisé 6063 de qualité aéronautique</strong> haut de gamme, pour une rotation fluide et une grande durabilité.",
        "Testé de façon indépendante par <strong>Orange Photonics</strong>.",
        "Lors de ces tests, la conception à dents micro-arrondies a affiché la <strong>meilleure rétention de THC après mouture</strong> parmi les types de grinders évalués."
       ]
      },
      {
       "title": "L'argumentaire de vente",
       "points": [
        "S'associe aux vaporisateurs à herbes sèches <strong>G Pen Dash II</strong> et <strong>G Pen Dash+</strong>.",
        "Une mouture homogène signifie un remplissage plus efficace et une meilleure production de vapeur — une vente additionnelle évidente avec tout appareil à herbes sèches.",
        "Ligne de positionnement : <strong>Plus intelligent par conception. Meilleur à chaque tour.</strong>"
       ]
      }
     ],
     "quiz": [
      {
       "q": "Qu'est-ce que le G Pen Slim 3-Piece Grinder ?",
       "choices": [
        "Un vaporisateur à herbes sèches",
        "Un grinder pour la fleur",
        "Une batterie 510",
        "Un outil à dab pour concentrés"
       ],
       "answer": 1,
       "why": "Le Slim est un grinder 3 parties : il prépare la fleur, il ne la vaporise pas."
      },
      {
       "q": "Quel type de dents le Slim utilise-t-il ?",
       "choices": [
        "Des dents acérées classiques",
        "Des dents micro-arrondies",
        "Des lames dentelées",
        "Des meules en céramique"
       ],
       "answer": 1,
       "why": "Les dents micro-arrondies séparent la fleur en douceur, contrairement à un grinder classique à dents acérées."
      },
      {
       "q": "Pourquoi la conception à dents arrondies fait-elle la différence ?",
       "choices": [
        "Elle moud plus vite que toute autre conception",
        "Elle aide à préserver les cannabinoïdes et les terpènes",
        "Elle permet de moudre des concentrés",
        "Elle évite d'avoir à nettoyer le grinder"
       ],
       "answer": 1,
       "why": "Une séparation plus douce aide à préserver les cannabinoïdes et les terpènes qui font le caractère unique de chaque variété."
      },
      {
       "q": "Que signifie « sans tamis » pour ce grinder ?",
       "choices": [
        "Il n'a pas de couvercle",
        "Il n'y a pas de tamis à kief : les trichomes restent mélangés à la matière moulue",
        "Il ne peut pas être démonté",
        "Il ne fonctionne qu'avec de la fleur sèche"
       ],
       "answer": 1,
       "why": "Une conception 3 parties sans tamis conserve les trichomes dans la matière moulue au lieu de les filtrer vers un compartiment séparé."
      },
      {
       "q": "De combien de parties le Slim se compose-t-il ?",
       "choices": [
        "2",
        "3",
        "4",
       ...
       "answer": 1,
       "why": "C'est un grinder 3 parties."
      },
      {
       "q": "Dans quel matériau le Slim est-il fabriqué ?",
       "choices": [
        "Acier inoxydable",
       ...
       "answer": 1,
       "why": "Un aluminium anodisé 6063 de qualité aéronautique haut de gamme assure une rotation fluide et une durabilité à toute épreuve."
      },
      {
       "q": "Qui a testé de façon indépendante la conception des dents du Slim ?",
       "choices": [
        "Orange Photonics",
        "Santa Cruz Shredder",
        "SGS",
       ...
       "answer": 0,
       "why": "C'est Orange Photonics qui a mené les tests indépendants."
      },
      {
       "q": "Qu'ont démontré ces tests indépendants ?",
       "choices": [
        "Le temps de mouture le plus rapide",
        "La meilleure rétention de THC après mouture parmi les types de grinders évalués",
        "Le prix au gramme le plus bas",
        "Le fonctionnement le plus silencieux"
       ],
       "answer": 1,
       "why": "La conception à dents micro-arrondies a démontré la meilleure rétention de THC après mouture parmi plusieurs types de grinders évalués."
      },
      {
       "q": "Avec quels appareils le Slim est-il conçu pour être associé ?",
       "choices": [
        "Hydout et 510 Original",
        "Dash II et Dash+",
        "Melt et Connect",
        "Micro+ et Hyer"
       ],
       "answer": 1,
       "why": "Il est conçu pour accompagner les vaporisateurs à herbes sèches G Pen Dash II et G Pen Dash+."
      },
      {
  ...
  "products": {
      "Micro II": {
        "description": "Un vaporisateur à concentrés compact doté de trois niveaux de chauffe, d'un flux d'air réglable, d'un écran numérique, d'une chauffe céramique et de jusqu'à 120 sessions par charge.",
        "highlights": [
          "Trois niveaux de chauffe : LOW ~295°F, MEDIUM ~340°F, HIGH ~395°F",
          ...
          "Compatible avec le Sidecar et l'adaptateur pour rig de 14 mm (vendus séparément)",
          "Utilisation simple à un seul bouton"
        ],
        "fullDescription": [
        ...
        "box": {
          "contents": [
            "Batterie G Pen Micro II",
            "Réservoir céramique G Pen Micro II",
            "Embout en silicone",
            "*Sidecar du Micro II vendu séparément",
            "*Adaptateur pour rig de 14 mm du Micro II vendu séparément"
          ]
        },
        "specs": [
          [
          ...
          [
            "Charge",
            "Charge rapide USB-C, moins de 60 minutes"
          ],
          [
            "Charge pass-through",
            "Oui"
          ...
          [
            "Mode Session",
            "Cycle de chauffe de 20 secondes (montée en température incluse)"
          ],
          [
            "Chauffe Manuelle",
            "Jusqu'à 25 secondes (montée en température incluse)"
          ],
          [
            "Atomiseur",
            "Céramique de 0.8Ω"
          ...
          [
            ...
            "Jusqu'à 120 sessions par charge"
          ],
          [
            "Arrêt automatique",
            "10 minutes"
    ...
    "Slim 3-Piece Grinder": {
     "description": "Un grinder 3 parties fin et sans tamis, doté de dents micro-arrondies qui séparent la fleur en douceur pour une mouture régulière — pensé pour accompagner les Dash II et Dash+.",
     "highlights": [
      "Dents micro-arrondies pour une mouture douce et homogène",
      "Aide à préserver les cannabinoïdes et les terpènes",
      "Conception 3 parties sans tamis : les trichomes restent dans votre matière",
     ...
     "fullDescription": [
      "Toute bonne session commence par une meilleure mouture. Le G Pen Slim 3-Piece Grinder est conçu autour de dents micro-arrondies innovantes qui séparent la fleur en douceur pour une mouture régulière, tout en aidant à préserver les cannabinoïdes et les terpènes qui font le caractère unique de chaque variété.",
      "Contrairement aux grinders classiques à dents acérées, la géométrie arrondie des dents du Slim et son intérieur lisse réduisent les frottements et limitent les résidus : votre fleur reste là où elle doit être. La conception 3 parties sans tamis garde également les trichomes mélangés à la matière moulue au lieu de les séparer, tandis que le profil compact se glisse partout — poche, voyages et usage quotidien.",
      "Façonné dans un aluminium anodisé 6063 de qualité aéronautique haut de gamme, le G Pen Slim offre une rotation fluide, une durabilité à toute épreuve et des performances précises. Lors de tests indépendants menés par Orange Photonics, cette conception innovante à dents micro-arrondies a démontré la meilleure rétention de THC après mouture parmi plusieurs types de grinders évalués.",
      "Pensé pour produire une mouture régulière, idéale pour la vaporisation, le G Pen Slim 3-Piece Grinder s'associe parfaitement aux vaporisateurs à herbes sèches G Pen Dash II et G Pen Dash+ : vous tirez le meilleur de chaque remplissage grâce à une mouture homogène et efficace, optimisée pour une vapeur pleine de saveurs.",
      "Plus intelligent par conception. Meilleur à chaque tour."
     ]
    },
    "Dash II": {
