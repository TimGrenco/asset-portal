...
window.PORTAL_I18N.pt = {
  "ui": {
    ...
    "Take the course on G Pen Training — watch the videos, learn the product and pass a short quiz to get certified.": "Faça o curso no G Pen Training: assista aos vídeos, conheça o produto e passe em um Quiz rápido para obter a certificação.",
    "Start training": "Iniciar treinamento",
    "Opens G Pen Training in a new tab": "Abre o G Pen Training em uma nova aba",
    "How to Use: G Pen Dash II": "Como usar: G Pen Dash II",
    "How to Use: G Pen 510 Original": "Como usar: G Pen 510 Original",
    "How to Use: G Pen Hydout": "Como usar: G Pen Hydout",
    "How to Use: G Pen Dash+": "Como usar: G Pen Dash+",
    "How to Use: G Pen Micro+": "Como usar: G Pen Micro+",
    "How to Clean: Dash II": "Como limpar: Dash II",
    "How to Clean: G Pen 510 Original": "Como limpar: G Pen 510 Original",
    "How to Clean: G Pen Hydout": "Como limpar: G Pen Hydout",
    "How to Clean: G Pen Dash+": "Como limpar: G Pen Dash+",
    "How to Clean: G Pen Micro+": "Como limpar: G Pen Micro+",
    "A Closer Look at the Melt": "Um olhar de perto no Melt",
    "G Pen Connect + Your Favorite Glass": "G Pen Connect + seu vidro favorito",
    "Connect to Favorite Glass": "Conecte ao seu vidro favorito",
    "How To Use Your G Pen Elite II": "Como usar seu G Pen Elite II",
    "Using the Elite II": "Usando o Elite II",
    "Products we no longer sell — assets kept here for partners who still need them.": "Produtos que não vendemos mais: os materiais ficam aqui para os parceiros que ainda precisam deles.",
    "Placeholder guide — the official {brand} brand guide will replace this. Colors, type, and logos below reflect current brand usage.": "Guia provisório: o guia de marca oficial da {brand} vai substituí-lo. As cores, a tipografia e os logotipos abaixo refletem o uso atual da marca.",
    "No assets match your filters.": "Nenhum material corresponde aos seus filtros.",
    "Request one →": "Solicite um →",
    "{n} more coming from Dropbox": "mais {n} chegando do Dropbox",
    "With vape holder": "Com suporte para vaporizador",
    "2.5\" L × 2.5\" W · 25 notes per pad": "2.5\" L × 2.5\" W · 25 folhas por bloco",
    "3ft Circular": "Circular de 3 ft",
    "How to Use: G Pen Micro II": "Como usar: G Pen Micro II",
    "How to Clean: G Pen Micro II": "Como limpar: G Pen Micro II",
    "How to Use: G Pen Micro II Sidecar": "Como usar: G Pen Micro II Sidecar",
    "How to Use: G Pen Micro II Rig Adapter": "Como usar: G Pen Micro II Rig Adapter",
