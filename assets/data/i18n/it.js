...
window.PORTAL_I18N.it = {
  "ui": {
    ...
    "View": "Visualizza",
    "{n} colors": "{n} colori",
    "Copied link to {folder}": "Link a {folder} copiato",
    ...
    "Take the course on G Pen Training — watch the videos, learn the product and pass a short quiz to get certified.": "Segua il corso su G Pen Training: guardi i video, impari a conoscere il prodotto e superi un breve quiz per ottenere la certificazione.",
    "Start training": "Inizia la formazione",
    "Opens G Pen Training in a new tab": "Apre G Pen Training in una nuova scheda",
    "How to Use: G Pen Dash II": "Come si usa: G Pen Dash II",
    "How to Use: G Pen 510 Original": "Come si usa: G Pen 510 Original",
    "How to Use: G Pen Hydout": "Come si usa: G Pen Hydout",
    "How to Use: G Pen Dash+": "Come si usa: G Pen Dash+",
    "How to Use: G Pen Micro+": "Come si usa: G Pen Micro+",
    "How to Clean: Dash II": "Come si pulisce: Dash II",
    "How to Clean: G Pen 510 Original": "Come si pulisce: G Pen 510 Original",
    "How to Clean: G Pen Hydout": "Come si pulisce: G Pen Hydout",
    "How to Clean: G Pen Dash+": "Come si pulisce: G Pen Dash+",
    "How to Clean: G Pen Micro+": "Come si pulisce: G Pen Micro+",
    "A Closer Look at the Melt": "Uno sguardo ravvicinato al Melt",
    "G Pen Connect + Your Favorite Glass": "G Pen Connect + il Suo vetro preferito",
    "Connect to Favorite Glass": "Lo colleghi al Suo vetro preferito",
    "How To Use Your G Pen Elite II": "Come usare il Suo G Pen Elite II",
    "Using the Elite II": "Utilizzo dell'Elite II",
    ...
    "Placeholder guide — the official {brand} brand guide will replace this. Colors, type, and logos below reflect current brand usage.": "Guida provvisoria: la guida ufficiale del marchio {brand} la sostituirà. Colori, caratteri e loghi qui sotto riflettono l'uso attuale del marchio.",
    "No assets match your filters.": "Nessun asset corrisponde ai filtri selezionati.",
    "Request one →": "Ne richieda uno →",
    "{n} more coming from Dropbox": "altri {n} in arrivo da Dropbox",
    "With vape holder": "Con porta-vaporizzatore",
    "2.5\" L × 2.5\" W · 25 notes per pad": "2.5\" L × 2.5\" W · 25 foglietti per blocco",
    "3ft Circular": "Circolare da 3 ft",
    "How to Use: G Pen Micro II": "Come si usa: G Pen Micro II",
    "How to Clean: G Pen Micro II": "Come si pulisce: G Pen Micro II",
    "How to Use: G Pen Micro II Sidecar": "Come si usa: G Pen Micro II Sidecar",
    "How to Use: G Pen Micro II Rig Adapter": "Come si usa: G Pen Micro II Rig Adapter",
